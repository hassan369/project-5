<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="goalProject.dashboard" %>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand"  style="background-color:#F24726; color:white;">
            ...
            <a class="navbar-brand me-2" href="homePage.aspx" runat="server">
                 <img src="images/loo.png" alt=" Logo" style=" height:40px; margin-left:50px;" />
    </a>
            <!-- Sidebar Toggle-->
           <%-- <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>--%>
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                   ...
                   <li><a class="dropdown-item" href="login.aspx" runat="server">Logout</a></li>
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="totalsales.aspx" runat="server">Total Sales</a>
</nav>
<%--navv.............--%>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card  text-white mb-4" style="background-color:#F24726;">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="totalsales.aspx" runat="server">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><canvas id="myAreaChart" width="1076" height="430" style="display: block; height: 215px; width: 538px;" class="chartjs-render-monitor"></canvas></div>
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body"><canvas id="myBarChart" width="1076" height="430" style="display: block; height: 215px; width: 538px;" class="chartjs-render-monitor"></canvas></div>
                                </div>
                            </div>
                        </div>
